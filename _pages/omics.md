...
Examples illustrating the application of machine learning methods in biomedical studies can be found [**here**](https://vanngocthuyla.github.io/_pages/machine_learning).
